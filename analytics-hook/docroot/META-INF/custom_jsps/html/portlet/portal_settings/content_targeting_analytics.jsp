...
<aui:fieldset>
	<aui:input helpMessage="anonymous-users-help" label="anonymous-users" name="settings--content.targeting.anonymous.users.enabled--" type="checkbox" value='<%= PrefsPropsUtil.getBoolean(company.getCompanyId(), "content.targeting.anonymous.users.enabled") %>' />
